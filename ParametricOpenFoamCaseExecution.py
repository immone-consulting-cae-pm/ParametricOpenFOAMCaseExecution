...
class ParametricOpenFoamCaseExecution:
    ...
    path_to_case_root = '/home/eero/OpenFOAM/eero-9/Programmatic_case'
    ...
    def execFoam(self):
        import subprocess
        subprocess.run('blockMesh', shell=True, cwd=ParametricOpenFoamCaseExecution.path_to_target,timeout=20)
        subprocess.run('simpleFoam', shell=True, cwd=ParametricOpenFoamCaseExecution.path_to_target,timeout=20)
        subprocess.run('foamToVTK', shell=True, cwd=ParametricOpenFoamCaseExecution.path_to_target,timeout=20)
